...
public class Message {
    ...
    /**
     * The text for this message (e.g., 'This is my first post!') must not be blank and must be under 255 characters.
     */
    ...
    /**
     * Properly named getters and setters are necessary for Jackson ObjectMapper to work. We may use them as well.
     * @return message_id
     */
